...
$(U^\one)^{-2/3}(V^\one)^{1/3}-(U-U^\one)^{-2/3}(V-V^\one)^{1/3}=0$

$\so (U^\one)^{-2/3}(V^\one)^{1/3}=(U-U^\one)^{-2/3}(V-V^\one)^{1/3}$

$\so \disp\Big(\frac{U^\one}{U-U^\one}\Big)^{-2/3}
=\Big(\frac{V-V^\one}{V^\one}\Big)^{1/3}$

$\so \disp\Big(\frac{U-U^\one}{U^\one}\Big)^2
=\frac{V-V^\one}{V^\one}$

$\so \disp\frac{U-U^\one}{U^\one}
=\pm\sqrt{\frac{V-V^\one}{V^\one}}$

$\disp\frac{U-U^\one}{U^\one}
=-\sqrt{\frac{V-V^\one}{V^\one}},\ V^\one<V$ とすると

$\disp\frac{U}{U^\one}
=1-\sqrt{\frac{V-V^\one}{V^\one}}<1$
...
よって
$\disp\frac{U-U^\one}{U^\one}
\ne -\sqrt{\frac{V-V^\one}{V^\one}}$ または $V^\one=V$ である

$V^\one=V$ ならば

$\disp+\sqrt{\frac{V-V^\one}{V^\one}}=-\sqrt{\frac{V-V^\one}{V^\one}}=0$である

よって
$\disp\frac{U-U^\one}{U^\one}
=\sqrt{\frac{V-V^\one}{V^\one}}$

$\so \disp U^\one=\frac{U}{1+\sqrt{\frac{V-V^\one}{V^\one}}}$\ \ (4.11)
...
\l[\l(\frac{U}{1+\sqrt{\frac{V-V^\one}{V^\one}}}V^\one\r)^{1/3}
+\l(\l(U-\frac{U}{1+\sqrt{\frac{V-V^\one}{V^\one}}}  \r)(V-V^\one) \r)^{1/3} \r] &\\
&=K\Big(\frac{UN}{2}\Big)^{1/3}
\l[ 
 \l(\frac{V^\one}{1+\sqrt{\frac{V-V^\one}{V^\one}}}\r)^{1/3}
+\l(\frac{V-V^\one}{1+\sqrt{\frac{V^\one}{V-V^\one}}} \r)^{1/3} 
\r] &
\end{flalign*}
$$
