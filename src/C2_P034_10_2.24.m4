...
## P.34 (2.24)  '25 6.30 {#C2_P034_10_2.24}
...
$\disp\limto{V}{\infty}\frac{\delta N}{V}=\limto{V}{\infty}\frac{\cdots+\delta \N{i}+\cdots}{V} = 0$

証明？

たとえば$\delta \N{i}$ が独立なら平均$\disp\frac{\cdots+\delta \N{i}+\cdots}{V}=0$といえる。
